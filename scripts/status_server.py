...
JOURNALS = {
    ...
    "corridor2":  BASE / "trading_journal_corridor2",
    "dca_nil":    BASE / "trading_journal_dca_nil",
    "dca_esp":    BASE / "trading_journal_dca_esp",
    "dca_ace":    BASE / "trading_journal_dca_ace",
    "dca_onu":    BASE / "trading_journal_dca_onu",
...
HISTORY_FILE = {
    ...
    "corridor2":  "corridor_history.json",
