...
AGENTS = {
    ...
    "max_grid2":  {"script": "grid_max_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_max2" / "grid_history.json",       "open": JOURNAL_BASE.parent / "trading_journal_max2" / "open_grids.json",    "env": {"FLOAT_INSTANCE": "max2", "FLOAT_BIAS": "long"}},
    "max_grid3":  {"script": "grid_max_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_max3" / "grid_history.json",       "open": JOURNAL_BASE.parent / "trading_journal_max3" / "open_grids.json",    "env": {"FLOAT_INSTANCE": "max3", "FLOAT_BIAS": "short"}},
