...
AGENTS = {
    ...
    "max_grid":   {"script": "grid_max_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_max" / "grid_history.json",        "open": JOURNAL_BASE.parent / "trading_journal_max" / "open_grids.json",     "env": {"FLOAT_INSTANCE": "max", "GRID_RANGE": "0.01", "GRID_ORDERS": "41", "TP_FACTOR": "2.5", "BALANCE_PER_GRID": "0.05", "MAX_LEVERAGE": "50", "BB_FILTER": "1"}},
    "max_grid4":  {"script": "grid_max_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_max4" / "grid_history.json",       "open": JOURNAL_BASE.parent / "trading_journal_max4" / "open_grids.json",    "env": {"FLOAT_INSTANCE": "max4", "GRID_RANGE": "0.03", "GRID_ORDERS": "41", "TP_FACTOR": "2.0", "BALANCE_PER_GRID": "0.04", "MAX_LEVERAGE": "30", "BB_FILTER": "1"}},
    ...
    "corridor2":  {"script": "grid_corridor_agent.py", "journal": JOURNAL_BASE.parent / "trading_journal_corridor2" / "corridor_history.json", "open": JOURNAL_BASE.parent / "trading_journal_corridor2" / "open_grids.json", "env": {"CORRIDOR_INSTANCE": "corridor2"}},
    "dca_nil":    {"script": "grid_dca_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_dca_nil" / "dca_history.json",   "open": JOURNAL_BASE.parent / "trading_journal_dca_nil" / "open_grids.json",   "env": {"DCA_INSTANCE": "nil", "DCA_SYMBOL": "NILUSDT"}},
    "dca_esp":    {"script": "grid_dca_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_dca_esp" / "dca_history.json",   "open": JOURNAL_BASE.parent / "trading_journal_dca_esp" / "open_grids.json",   "env": {"DCA_INSTANCE": "esp", "DCA_SYMBOL": "ESPUSDT"}},
    "dca_ace":    {"script": "grid_dca_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_dca_ace" / "dca_history.json",   "open": JOURNAL_BASE.parent / "trading_journal_dca_ace" / "open_grids.json",   "env": {"DCA_INSTANCE": "ace", "DCA_SYMBOL": "ACEUSDT"}},
    "dca_onu":    {"script": "grid_dca_agent.py",      "journal": JOURNAL_BASE.parent / "trading_journal_dca_onu" / "dca_history.json",   "open": JOURNAL_BASE.parent / "trading_journal_dca_onu" / "open_grids.json",   "env": {"DCA_INSTANCE": "onu", "DCA_SYMBOL": "ONUSDT"}},
