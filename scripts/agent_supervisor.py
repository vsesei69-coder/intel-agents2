...
AGENTS = {
    ...
    "corridor3":  {"script": "grid_corridor_agent.py", "journal": JOURNAL_BASE.parent / "trading_journal_corridor3" / "corridor_history.json", "open": JOURNAL_BASE.parent / "trading_journal_corridor3" / "open_grids.json", "env": {"CORRIDOR_INSTANCE": "corridor3"}},
